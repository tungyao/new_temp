...
#define I2C_SDA_UP        HAL_GPIO_WritePin(QSDA_GPIO_Port,QSDA_Pin,GPIO_PIN_SET)                //SDA高电平
#define I2C_SDA_LOW        HAL_GPIO_WritePin(QSDA_GPIO_Port,QSDA_Pin,GPIO_PIN_RESET)            //SDA低电平
#define I2C_SCL_UP        HAL_GPIO_WritePin(QSCL_GPIO_Port,QSCL_Pin,GPIO_PIN_SET)              //SCL高电平
#define I2C_SCL_LOW        HAL_GPIO_WritePin(QSCL_GPIO_Port,QSCL_Pin,GPIO_PIN_RESET)            //SCL低电平



/* 获取 SDA SCL 引脚状态，标准库版也是用相同逻辑    */

#define I2C_SDA        HAL_GPIO_ReadPin(QSDA_GPIO_Port ,QSDA_Pin)        //获取SDA引脚状态
#define I2C_SCL        HAL_GPIO_ReadPin(QSCL_GPIO_Port ,QSCL_Pin)        //获取SCL引脚状态
